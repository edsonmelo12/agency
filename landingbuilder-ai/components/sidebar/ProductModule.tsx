    ...
    return (
      <div className="space-y-6 animate-in fade-in pb-20">
        ...
        <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-2xl gap-1">
           <button onClick={() => setActiveTab('base')} className={`flex-1 py-2 text-[10px] font-black rounded-xl transition-all ${activeTab === 'base' ? 'bg-white dark:bg-slate-700 text-indigo-600 dark:text-white shadow-sm' : 'text-slate-400'}`}>Oferta</button>
           <button onClick={() => setActiveTab('strategy')} className={`flex-1 py-2 text-[10px] font-black rounded-xl transition-all ${activeTab === 'strategy' ? 'bg-white dark:bg-slate-700 text-indigo-600 dark:text-white shadow-sm' : 'text-slate-400'}`}>Estratégia</button>
           <button onClick={() => setActiveTab('proof')} className={`flex-1 py-2 text-[10px] font-black rounded-xl transition-all ${activeTab === 'proof' ? 'bg-white dark:bg-slate-700 text-indigo-600 dark:text-white shadow-sm' : 'text-slate-400'}`}>Provas</button>
        </div>
            ...
            <Card>
              <div className="space-y-4">
                <div className="space-y-1">
                  <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Nome do Produto</span>
                ...
                <div className="grid grid-cols-2 gap-3">
                   <div className="space-y-1">
                      <span className="text-[9px] font-black text-blue-600 uppercase tracking-widest font-bold">Preço de Venda</span>
                      <Input value={editData.price} onChange={e => setEditData({...editData, price: e.target.value})} placeholder="Ex: R$ 997,00" className="!border-blue-200" />
                   </div>
                   <div className="space-y-1">
                      <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Garantia (Dias)</span>
                ...
                <div className="space-y-1">
                  <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Promessa Irresistível (Headline)</span>
                ...
                <div className="space-y-1">
                  <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Nicho / Sub-nicho</span>
                ...
                <div className="space-y-2">
                   <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Mockup / Visual do Produto</span>
                   <div onClick={() => productImgRef.current?.click()} className="w-full h-32 bg-slate-50 dark:bg-slate-800 border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-2xl flex items-center justify-center cursor-pointer hover:border-indigo-500 overflow-hidden shadow-inner transition-all">
                     {editData.imageUrl ? (
                       ...
                       <div className="text-center">
                         ...
                         <span className="text-[8px] font-black uppercase text-slate-400">Inserir Mockup 3D</span>
                       </div>
                     )}
                   </div>
        ...
        {activeTab === 'strategy' && (
          <div className="space-y-6 animate-in slide-in-from-right-4">
            <Card color="indigo">
               <div className="space-y-4">
                  <div className="space-y-1">
                     <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">O que eles vão aprender?</span>
                  ...
                  <div className="space-y-1">
                     <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Entregáveis & Bônus</span>
            ...
            <Card color="slate">
               ...
               <div className="space-y-4">
                  <div className="space-y-1">
                     <span className="text-[9px] font-black text-slate-500 uppercase">Público Alvo / Persona</span>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                      <span className="text-[9px] font-black text-slate-500 uppercase">Faixa Etária</span>
                    ...
                    <div className="space-y-1">
                      <span className="text-[9px] font-black text-slate-500 uppercase">Gênero</span>
                  ...
                  <div className="space-y-1">
                     <span className="text-[9px] font-black text-slate-500 uppercase">Desejos & Sonhos</span>
                  ...
                  <div className="space-y-1">
                     <span className="text-[9px] font-black text-slate-500 uppercase">Dores & Problemas</span>
                  ...
                  <div className="space-y-1">
                     <span className="text-[9px] font-black text-slate-500 uppercase">Objeções Principais</span>
          ...
          <div className="space-y-6 animate-in slide-in-from-right-4">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button onClick={addTestimonial} className="text-[9px] font-black text-blue-600 uppercase">+ Adicionar</button>
              </div>
              <div className="space-y-2">
                ...
                {(!editData.testimonials || editData.testimonials.length === 0) && <p className="text-center py-4 text-[9px] font-bold text-slate-400 uppercase">Nenhum depoimento cadastrado.</p>}
              </div>
            </div>
            ...
            <div className="space-y-3">
               <div className="flex items-center justify-between">
                  ...
                  <button onClick={addFaq} className="text-[9px] font-black text-blue-600 uppercase">+ Adicionar</button>
               </div>
               <div className="space-y-4">
                  {(editData.faq || []).map((f, i) => (
                    <div key={i} className="p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl space-y-2 border border-slate-100 dark:border-slate-700">
    ...
    <div className="space-y-6">
       <Card color="indigo">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={handleImportUrl} disabled={isAiFilling} className="!py-3 !px-4 bg-indigo-600 min-w-[80px]">
       ...
       <div className="flex items-center justify-between">
          ...
          <button onClick={startNew} className="text-[10px] font-black text-blue-600 uppercase hover:underline">+ Criar Oferta</button>
       </div>
       
       <div className="space-y-3">
          {products.map(prod => (
            <div key={prod.id} onClick={() => onSelectProduct(prod)} className={`p-4 rounded-[32px] border-2 cursor-pointer transition-all group relative ${activeProduct?.id === prod.id ? 'border-indigo-600 bg-indigo-50 dark:bg-indigo-900/10 shadow-lg' : 'border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-indigo-200'}`}>
               <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 overflow-hidden">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                       <span className="text-[10px] font-black text-indigo-600">{prod.price || 'R$ 0,00'}</span>
                       <span className="text-[8px] font-bold text-slate-400 uppercase">• {prod.guaranteeDays}d Garantia</span>
                    </div>
                  </div>
               </div>
               <div className="absolute top-4 right-4 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button onClick={(e) => { e.stopPropagation(); setEditData(prod); }} className="p-2 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl text-slate-500 hover:text-indigo-600 shadow-sm">
                  ...
                  <button onClick={(e) => { e.stopPropagation(); if(confirm('Excluir oferta?')) deleteProduct(prod.id).then(() => getProductsByExpert(activeExpert.id).then(setProducts)); }} className="p-2 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl text-rose-400 hover:text-rose-600 shadow-sm">
