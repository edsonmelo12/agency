...
const VslModule: React.FC<Props> = ({ onGenerate, isLoading }) => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in">
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              ...
              <button 
                ...
                className={`p-3 rounded-xl border flex flex-col items-center gap-1 transition-all ${duration === d.id ? 'bg-blue-600 border-blue-600 text-white shadow-lg' : 'bg-white dark:bg-slate-800 border-slate-100 dark:border-slate-700 text-slate-400'}`}
              >
      ...
      <Card color="indigo">
        <h4 className="text-[10px] font-black uppercase text-indigo-600 mb-2">Dica de Conversão</h4>
