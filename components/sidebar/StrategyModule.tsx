          ...
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-2">
              <div className="space-y-1">
                <span className="text-[9px] font-bold text-slate uppercase">WhatsApp</span>
                <Input 
              ...
              <div className="space-y-1">
                <span className="text-[9px] font-bold text-slate uppercase">E-mail</span>
                <Input 
            ...
            <div className="space-y-1">
              <span className="text-[9px] font-bold text-slate uppercase">Instagram</span>
              <Input 
            ...
            <div className="space-y-1">
              <span className="text-[9px] font-bold text-slate uppercase">TikTok</span>
              <Input 
            ...
            <div className="space-y-1">
              <span className="text-[9px] font-bold text-slate uppercase">Facebook</span>
              <Input 
            ...
            <div className="space-y-1">
              <span className="text-[9px] font-bold text-slate uppercase">YouTube</span>
              <Input 
            ...
            <div className="space-y-1">
              <span className="text-[9px] font-bold text-slate uppercase">LinkedIn</span>
              <Input 
        ...
        <Card color="blue">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2 text-center">
              <span className="text-[9px] font-bold text-slate uppercase">Logo da Marca</span>
              <div 
                ...
                className="w-full aspect-square bg-white dark:bg-slate-800 border-2 border-dashed border-border dark:border-slate-700 rounded-3xl flex flex-col items-center justify-center cursor-pointer hover:border-primary overflow-hidden shadow-sm transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
              >
                {editData.brandKit.logoUrl ? (
                  ...
                  <div className="p-2">
                    ...
                    <span className="text-[8px] font-black uppercase text-slate">Logo</span>
                  </div>
                )}
              </div>
            ...
            <div className="space-y-2 text-center">
              <span className="text-[9px] font-bold text-slate uppercase">Foto Expert</span>
              <div 
              ...
              >
                {editData.brandKit.photoUrl ? (
                  ...
                  <div className="p-2">
                    ...
                    <span className="text-[8px] font-black uppercase text-slate">Foto</span>
                  </div>
                )}
              </div>
  ...
  return (
    <div className="space-y-6 animate-in fade-in pb-20">
      <div className="flex items-center justify-between mb-4">
         ...
         <button onClick={startNew} className="text-[10px] font-black text-primary uppercase">+ Novo Expert</button>
      </div>
      ...
      <div className="grid grid-cols-1 gap-3">
        {experts.map(exp => (
          <div
            ...
            className={`p-4 rounded-[24px] border-2 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 cursor-pointer group relative ${activeExpert?.id === exp.id ? 'border-primary bg-blue-50 dark:bg-blue-900/10 shadow-lg shadow-blue-500/5' : 'border-border dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-primary'}`}
          >
            <div className="flex items-center gap-4">
               <div className="w-12 h-12 rounded-2xl bg-white dark:bg-slate-800 flex items-center justify-center border border-border dark:border-slate-700 overflow-hidden shadow-sm">
               ...
               <div className="flex-1 overflow-hidden">
                  ...
                  <p className="text-[9px] font-bold text-slate mt-0.5">{exp.authority.slice(0, 30)}...</p>
               </div>
            </div>
            <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
               <button onClick={(e) => { e.stopPropagation(); setEditData(exp); }} className="p-2 bg-white dark:bg-slate-800 border border-border dark:border-slate-700 rounded-xl text-slate hover:text-primary shadow-sm">
               ...
               <button onClick={(e) => { e.stopPropagation(); deleteExpert(exp.id).then(loadExperts); }} className="p-2 bg-white dark:bg-slate-800 border border-border dark:border-slate-700 rounded-xl text-rose-400 hover:text-rose-600 shadow-sm">
