...
const UsersWorkspace: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col gap-6 p-8">
      <div className="flex flex-col gap-2 max-w-2xl text-slate-500">
        ...
        <p className="text-base text-slate-500">Lista organizada com filtros e ações inline para o CRUD completo.</p>
      </div>
      ...
      <div className="flex-1 overflow-hidden rounded-[36px] border border-slate-200 bg-white shadow-[0_35px_80px_rgba(15,23,42,0.35)]">
